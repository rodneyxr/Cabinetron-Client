...
public class InventoryItemController {
	...
	public void addInventoryItem(InventoryItemView iiv) {
		...
		System.out.println("InventoryItemView: " + newItem);
		parent.setVisible(false);
		parent.setUpdateOnly();
		newItem.setItemView(parent);
	}
	...
	public void updateInventoryItem(InventoryItemView iiv) {
		System.out.println("InventoryItemView: 'Update Item' button clicked.");
		...
		if (timeStamp != oldTimeStamp) {
			...
			System.out.println("Timestamps are the same! continue with update");
